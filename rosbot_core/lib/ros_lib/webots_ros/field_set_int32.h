#ifndef _ROS_SERVICE_field_set_int32_h
#define _ROS_SERVICE_field_set_int32_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_SET_INT32[] = "webots_ros/field_set_int32";

  class field_set_int32Request : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_SET_INT32; };
    const char * getMD5(){ return "c4e4761c73394851ea983661c7998e61"; };

  };

  class field_set_int32Response : public ros::Msg
  {
    public:
      typedef int32_t _success_type;
      _success_type success;

    field_set_int32Response():
      success(0)
    {
    }
