#ifndef _ROS_SERVICE_field_get_vec2f_h
#define _ROS_SERVICE_field_get_vec2f_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_VEC2F[] = "webots_ros/field_get_vec2f";

  class field_get_vec2fRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_GET_VEC2F; };
    const char * getMD5(){ return "828947932ebb9e813d3ef918f20f0d81"; };

  };

  class field_get_vec2fResponse : public ros::Msg
  {
    public:
      typedef geometry_msgs::Vector3 _value_type;
      _value_type value;

    field_get_vec2fResponse():
      value()
    {
    }
    ...
    const char * getType(){ return FIELD_GET_VEC2F; };
    const char * getMD5(){ return "a2c51c1a0258b375bed188057dceaac2"; };

  };

  class field_get_vec2f {
    public:
