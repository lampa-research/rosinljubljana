#ifndef _ROS_SERVICE_field_remove_node_h
#define _ROS_SERVICE_field_remove_node_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_REMOVE_NODE[] = "webots_ros/field_remove_node";

  class field_remove_nodeRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_REMOVE_NODE; };
    const char * getMD5(){ return "e93ba679ed362db7a38da88ce503a380"; };

  };

  class field_remove_nodeResponse : public ros::Msg
  {
    public:
      typedef int32_t _success_type;
      _success_type success;

    field_remove_nodeResponse():
      success(0)
    {
    }
