#ifndef _ROS_SERVICE_field_set_vec3f_h
#define _ROS_SERVICE_field_set_vec3f_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_SET_VEC3F[] = "webots_ros/field_set_vec3f";

  class field_set_vec3fRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_SET_VEC3F; };
    const char * getMD5(){ return "e78e366a5838b6427603da25de1ca26d"; };

  };

  class field_set_vec3fResponse : public ros::Msg
  {
    public:
      typedef int32_t _success_type;
      _success_type success;

    field_set_vec3fResponse():
      success(0)
    {
    }
