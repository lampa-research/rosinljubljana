#ifndef _ROS_SERVICE_node_get_type_h
#define _ROS_SERVICE_node_get_type_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_GET_TYPE[] = "webots_ros/node_get_type";

  class node_get_typeRequest : public ros::Msg
  {
    public:
      typedef uint64_t _node_type;
      _node_type node;

    node_get_typeRequest():
      node(0)
    {
    }
    ...
    const char * getType(){ return NODE_GET_TYPE; };
    const char * getMD5(){ return "364f76d0680a5475664d98abd705f036"; };

  };

  class node_get_typeResponse : public ros::Msg
  {
    public:
      typedef int32_t _type_type;
      _type_type type;

    node_get_typeResponse():
      type(0)
    {
    }
