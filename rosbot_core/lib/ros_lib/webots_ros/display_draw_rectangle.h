#ifndef _ROS_SERVICE_display_draw_rectangle_h
#define _ROS_SERVICE_display_draw_rectangle_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char DISPLAY_DRAW_RECTANGLE[] = "webots_ros/display_draw_rectangle";

  class display_draw_rectangleRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return DISPLAY_DRAW_RECTANGLE; };
    const char * getMD5(){ return "4425f1067abc7ec2e487d28194eccff4"; };

  };

  class display_draw_rectangleResponse : public ros::Msg
  {
    public:
      typedef int8_t _success_type;
      _success_type success;

    display_draw_rectangleResponse():
      success(0)
    {
    }
