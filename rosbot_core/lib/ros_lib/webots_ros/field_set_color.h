#ifndef _ROS_SERVICE_field_set_color_h
#define _ROS_SERVICE_field_set_color_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_SET_COLOR[] = "webots_ros/field_set_color";

  class field_set_colorRequest : public ros::Msg
  {
    public:
      ...
      _index_type index;
      typedef std_msgs::ColorRGBA _value_type;
      _value_type value;

    field_set_colorRequest():
      field(0),
      index(0),
      value()
    {
    ...
    const char * getType(){ return FIELD_SET_COLOR; };
    const char * getMD5(){ return "ae309348d6fdd3fa0e43829b8bba7c9c"; };

  };

  class field_set_colorResponse : public ros::Msg
  {
    public:
      typedef int32_t _success_type;
      _success_type success;

    field_set_colorResponse():
      success(0)
    {
    }
