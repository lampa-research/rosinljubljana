#ifndef _ROS_SERVICE_field_get_type_h
#define _ROS_SERVICE_field_get_type_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_TYPE[] = "webots_ros/field_get_type";

  class field_get_typeRequest : public ros::Msg
  {
    public:
      typedef uint64_t _field_type;
      _field_type field;

    field_get_typeRequest():
      field(0)
    {
    }
    ...
    const char * getType(){ return FIELD_GET_TYPE; };
    const char * getMD5(){ return "6e05f2ccbc5e22655a0890e2557862bd"; };

  };

  class field_get_typeResponse : public ros::Msg
  {
    public:
      typedef int32_t _type_type;
      _type_type type;

    field_get_typeResponse():
      type(0)
    {
    }
