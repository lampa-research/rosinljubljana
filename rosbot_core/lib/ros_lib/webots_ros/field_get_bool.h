#ifndef _ROS_SERVICE_field_get_bool_h
#define _ROS_SERVICE_field_get_bool_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_BOOL[] = "webots_ros/field_get_bool";

  class field_get_boolRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_GET_BOOL; };
    const char * getMD5(){ return "828947932ebb9e813d3ef918f20f0d81"; };

  };

  class field_get_boolResponse : public ros::Msg
  {
    public:
      typedef uint8_t _value_type;
      _value_type value;

    field_get_boolResponse():
      value(0)
    {
    }
    ...
    const char * getType(){ return FIELD_GET_BOOL; };
    const char * getMD5(){ return "e4da51e86d3bac963ee2bb1f41031407"; };

  };

  class field_get_bool {
    public:
