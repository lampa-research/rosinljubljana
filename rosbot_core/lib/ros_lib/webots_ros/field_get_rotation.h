#ifndef _ROS_SERVICE_field_get_rotation_h
#define _ROS_SERVICE_field_get_rotation_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_ROTATION[] = "webots_ros/field_get_rotation";

  class field_get_rotationRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_GET_ROTATION; };
    const char * getMD5(){ return "828947932ebb9e813d3ef918f20f0d81"; };

  };

  class field_get_rotationResponse : public ros::Msg
  {
    public:
      typedef geometry_msgs::Quaternion _value_type;
      _value_type value;

    field_get_rotationResponse():
      value()
    {
    }
    ...
    const char * getType(){ return FIELD_GET_ROTATION; };
    const char * getMD5(){ return "eb57f1ee3cba115a75a1a64a523bbed1"; };

  };

  class field_get_rotation {
    public:
