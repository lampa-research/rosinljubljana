#ifndef _ROS_SERVICE_node_remove_h
#define _ROS_SERVICE_node_remove_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_REMOVE[] = "webots_ros/node_remove";

  class node_removeRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return NODE_REMOVE; };
    const char * getMD5(){ return "364f76d0680a5475664d98abd705f036"; };

  };

  class node_removeResponse : public ros::Msg
  {
    public:
