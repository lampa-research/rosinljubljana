#ifndef _ROS_SERVICE_field_set_bool_h
#define _ROS_SERVICE_field_set_bool_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_SET_BOOL[] = "webots_ros/field_set_bool";

  class field_set_boolRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_SET_BOOL; };
    const char * getMD5(){ return "0821d1633b8eb3778038202526082536"; };

  };

  class field_set_boolResponse : public ros::Msg
  {
    public:
      typedef int32_t _success_type;
      _success_type success;

    field_set_boolResponse():
      success(0)
    {
    }
