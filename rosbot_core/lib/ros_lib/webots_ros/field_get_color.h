#ifndef _ROS_SERVICE_field_get_color_h
#define _ROS_SERVICE_field_get_color_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char FIELD_GET_COLOR[] = "webots_ros/field_get_color";

  class field_get_colorRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return FIELD_GET_COLOR; };
    const char * getMD5(){ return "828947932ebb9e813d3ef918f20f0d81"; };

  };

  class field_get_colorResponse : public ros::Msg
  {
    public:
      typedef std_msgs::ColorRGBA _value_type;
      _value_type value;

    field_get_colorResponse():
      value()
    {
    }
    ...
    const char * getType(){ return FIELD_GET_COLOR; };
    const char * getMD5(){ return "3fa1443a84523e49855f24a6bde287af"; };

  };

  class field_get_color {
    public:
